...
- 2.6 过线外点作垂线 *2L 3E*  
解：[2L，如图做两个圆。](solving/Euclidea3/2.6.1.png)  
解：[3E，以给定点为圆心做圆，和直接交点的垂分线必然通过圆心。](solving/Euclidea3/2.6.2.png)  
...
解：[6E，圆外切等边三角形，高是1.5倍直径长。如图得到三条边。](solving/Euclidea3/4.3.2.png)  
